...
public class GiveUtils {
    ...
    private final static SimpleCommandExceptionType NO_SPACE = new SimpleCommandExceptionType(Text.literal("快捷栏已满，没有空间。"));
    ...
    static {
        ...
        PRESETS.put("force_op", (preview) -> {
            ...
            item.set(DataComponentTypes.CUSTOM_NAME, Text.of("强制OP"));
            return item;
        });
        ...
        PRESETS.put("troll_potion", (preview) -> {
            ...
            stack.set(DataComponentTypes.CUSTOM_NAME, Text.literal("恶搞药水"));
            return stack;
        });
        ...
        PRESETS.put("32k", (preview) -> {
            ...
            stack.set(DataComponentTypes.CUSTOM_NAME, Text.literal("32k剑"));
            return stack;
        });
        ...
        PRESETS.put("crash_chest", (preview) -> {
            ...
            stack.set(DataComponentTypes.CUSTOM_NAME, Text.literal("崩溃箱子"));
            return stack;
        });
