...
public class AutoPot extends Module {
    private static final List<Class<? extends Module>> AURAS = Arrays.asList(
        KillAura.class,
        CrystalAura.class
    );
    ...
    public AutoPot() {
        super(MeteorRejectsAddon.CATEGORY, "自动药水", "自动喝药水。");
    }
