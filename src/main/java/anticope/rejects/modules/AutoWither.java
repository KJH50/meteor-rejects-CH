...
public class AutoWither extends Module {
    ...
    public AutoWither() {
        super(MeteorRejectsAddon.CATEGORY, "自动凋灵", "自动建造凋灵。");
    }
