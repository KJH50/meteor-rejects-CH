...
public class NewChunks extends Module {
    ...
    public NewChunks() {
        super(MeteorRejectsAddon.CATEGORY,"新区块检测", "通过某些特征检测完全新生成的区块");
    }
